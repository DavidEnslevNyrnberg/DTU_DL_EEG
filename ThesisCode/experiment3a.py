...
if __name__ == '__main__':
    ...
    try:
        ...
        print(args.index, args.subsample, args.label)
        print('model:%i_label:%s_subsample_%.2f' %
              (args.index, label_column_strings[args.label], args.subsample))
        ...
        # scoring models
        algo_scoring = dict()
        save_score_path = r'tmp/experiment3'
        ...
        for alg in [select_alg[args.index]]:
            ...
            lars_table["model names"].append(
                alg.name.split("_")[-1] + '_%i_%s_subsample_%.2f' %
                (args.index, label_column_strings[args.label], args.subsample))
        ...
        performance_wide.to_csv(save_score_path + r'/perf_table_2021_03_21_%i_%s_subsample_%.2f.csv' %
                                (args.index, label_column_strings[args.label], args.subsample),
                                encoding='utf-8-sig')
        print("end of code")
