...
if __name__ == '__main__':
    ...
    try:
        ...
        for alg in [select_alg[args.index]]:
            ...
            lars_table["model names"].append(alg.name.split("_")[-1]+'_index%i_subsample_%.2f' % (args.index, args.subsample))
        ...
        performance_wide.to_csv(save_score_path+r'/perf_table_2021_03_21_index%i_subsample_%.2f.csv' %
                               (args.index, args.subsample), encoding='utf-8-sig')
        print("end of code")
