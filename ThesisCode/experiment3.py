...
if __name__ == '__main__':
    ...
    try:
        ...
        for alg in [select_alg[args.index]]:
            ...
            lars_table["model names"].append(alg.name.split("_")[-1]+'_label%i_subsample_%.2f_%i' % (args.label, args.subsample, args.index))
        ...
        performance_wide.to_csv(save_score_path+r'/perf_table_2021_03_21_label%i_subsample_%.2f_%i.csv' %
                               (args.label, args.subsample, args.index), encoding='utf-8-sig')
        print("end of code")
