...
## Experiment 2 notes: For TUAR14_null30 do we want: table, blue_plot(pred), blue_plot(target), blue_plot(neg)
...
if save_fig is True:
    TUAR14_pred_eyem.savefig(save_path+r"\ex2_TUAR14_pred_eyem.pdf", format='pdf', bbox_inches='tight')
if show_fig is True:
...
TUAR14_target_eyem = blue_plot(target_image_eyem, "Subject ID", "Window num [s]",
                               ...
                               **{"cmap":cm_eyem, "norm":norm_eyem})
if save_fig is True:
    TUAR14_target_eyem.savefig(save_path+r"\ex2_TUAR14_target_eyem.pdf", format='pdf', bbox_inches='tight')
if show_fig is True:
...
if save_fig is True:
    TUAR14_diff_eyem.savefig(save_path+r"\ex2_TUAR14_diff_eyem.pdf", format='pdf', bbox_inches='tight')
if show_fig is True:
...
if save_fig is True:
    TUAR14_pred_musc.savefig(save_path+r"\ex2_TUAR14_pred_musc.pdf", format='pdf', bbox_inches='tight')
if show_fig is True:
...
TUAR14_target_musc = blue_plot(target_image_musc, "Subject ID", "Window num [s]",
                               ...
                               **{"cmap":cm_musc, "norm":norm_musc})
if save_fig is True:
    TUAR14_target_musc.savefig(save_path+r"\ex2_TUAR14_target_musc.pdf", format='pdf', bbox_inches='tight')
if show_fig is True:
...
TUAR14_diff_musc = blue_plot(diff_image_null, "Subject ID", "Window num [s]",
                             ["TUAR14 confusion blue-plot$_{null}$", ['false negative', 'musc', 'false positive']], t_reso,
                             **{"cmap":cm_musc_diff, "norm":norm_musc_diff})
if save_fig is True:
    TUAR14_diff_musc.savefig(save_path+r"\ex2_TUAR14_diff_musc.pdf", format='pdf', bbox_inches='tight')
if show_fig is True:
...
if save_fig is True:
    TUAR14_pred_null.savefig(save_path+r"\ex2_TUAR14_pred_null.pdf", format='pdf', bbox_inches='tight')
if show_fig is True:
...
TUAR14_target_null = blue_plot(target_image_null, "Subject ID", "Window num [s]",
                               ...
                               **{"cmap":cm_null, "norm":norm_null})
if save_fig is True:
    TUAR14_target_null.savefig(save_path+r"\ex2_TUAR14_target_null.pdf", format='pdf', bbox_inches='tight')
if show_fig is True:
...
if save_fig is True:
    TUAR14_diff_eyem.savefig(save_path+r"\ex2_TUAR14_diff_null.pdf", format='pdf', bbox_inches='tight')
if show_fig is True:
    TUAR14_diff_eyem.show()
